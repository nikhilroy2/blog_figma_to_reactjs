...
function BlogUpload(props) {
    window.document.title = 'BlogUpload'
            ...
            <section>
                <div className="container_wrapper">
                    <div className="section_header">
                        ...
                        <input type="file" name="upload_images" style={{ display: 'none' }} id="upload_images" />
                    ...
                    <div className="section_body">
                        ...
                        <div className="form_group">
                            ...
                            <textarea className="form_control" placeholder='Enter Description'></textarea>
                        </div>
                    </div>
